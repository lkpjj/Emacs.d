...
unwanted space when exporting org-mode to html."
      ...
      (setq org-agenda-files (quote ("~/Workspace/org-notes" )))
      (setq org-default-notes-file "~/Workspace/org-notes/gtd.org")
      ...
      (setq org-capture-templates
            '(("t" "Todo" entry (file+headline "~/Workspace/org-notes/gtd.org" "Workspace")
               "* TODO [#B] %?\n  %i\n"
               :empty-lines 1)
              ("n" "notes" entry (file+headline "~/Workspace/org-notes/notes.org" "Quick notes")
               "* %?\n  %i\n %U"
               :empty-lines 1)
              ("b" "Blog Ideas" entry (file+headline "~/Workspace/org-notes/notes.org" "Blog Ideas")
               "* TODO [#B] %?\n  %i\n %U"
               :empty-lines 1)
              ("s" "Code Snippet" entry
               (file "~/Workspace/org-notes/snippets.org")
               "* %?\t%^g\n#+BEGIN_SRC %^{language}\n\n#+END_SRC")
              ("w" "work" entry (file+headline "~/Workspace/org-notes/gtd.org" "Cocos2D-X")
               "* TODO [#A] %?\n  %i\n %U"
               :empty-lines 1)
              ("c" "Chrome" entry (file+headline "~/Workspace/org-notes/notes.org" "Quick notes")
               "* TODO [#C] %?\n %(zilongshanren/retrieve-chrome-current-tab-url)\n %i\n %U"
               :empty-lines 1)
              ("l" "links" entry (file+headline "~/Workspace/org-notes/notes.org" "Quick notes")
               "* TODO [#C] %?\n  %i\n %a \n %U"
               :empty-lines 1)
              ("j" "Journal Entry"
               entry (file+datetree "~/Workspace/org-notes/journal.org")
               "* %?"
               :empty-lines 1)))
...
<li><a href='/index.html'>Wiki目录</a></li>
    ...
    <link rel=\"stylesheet\" type=\"text/css\" href=\"/css/worg.css\"/>")
      (setq org-publish-project-alist
            `(
              ("blog-notes"
               ...
               :base-extension "org"
               :publishing-directory "~/Workspace/org-notes/public_html/"
      ...
      (setq org-mobile-directory "~/Workspace/org-notes/org")
...
(defun zilongshanren-org/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/Workspace/org-notes")))
...
(defun zilongshanren-org/post-init-deft ()
  (progn
    ...
    (setq deft-directory "~/Workspace/org-notes")))
