...
values."
  (setq-default
   ...
   ;; a layer lazily. ;; (setq magit-display-buffer-function 'magit-display-buffer-fullframe-status-v1)
   ;; (default t)
   ...
   ;; List of conf;; (setq magit-display-buffer-function 'magit-display-buffer-fullframe-status-v1)
